...
/**
 * -Clase encargada de seleccionar un {@link Restaurante} para luego hacer una compra.
 ...
 * @see JOptionPane
 */
public class PedirComida extends javax.swing.JFrame implements Serializable{
    ...
    public PedirComida() {
        ...
        Cliente clienteActual = Sistema.getClienteActual();
        String clCP = clienteActual.getDireccion().getCodigoPostal();
    ...
    private void pedirComidaBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedirComidaBotonActionPerformed
        ...
        if(!restaurantesLista.isSelectionEmpty())
        {
                ...
                //Actualizo la pagina
                ComprarComidaCliente reinicio = new ComprarComidaCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedirComida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedirComida().setVisible(true);
            }
        });
    }
