...
/**
 * -Clase encargada de asignar una nueva calificacion a un {@link Restaurante} y actualizar su media.
 ...
 * @see JOptionPane
 */
public class CalificarRestauranteCliente extends javax.swing.JFrame implements Serializable {

    int xMouse,yMouse;
    DefaultListModel modeloRestaurantes = new DefaultListModel();           //Creamos un modelo para restaurantesLista(JList)
    
    
    public CalificarRestauranteCliente() {
    ...
    private void initComponents() {
        ...
        background.add(dosEstrellaRBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, -1, -1));
        ...
        background.add(tresEstrellaRBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, -1, -1));
        ...
        background.add(cuatroEstrellaRBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 500, -1, -1));
        ...
        background.add(cincoEstrellaRBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, -1, -1));
        ...
        background.add(dosEstrellas, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 120, 50));
        dosEstrellas.setIcon(new ImageIcon("Imagenes/2Estrella.png"));
        background.add(tresEstrellas, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 400, 210, 50));
        tresEstrellas.setIcon(new ImageIcon("Imagenes/3Estrella.png"));
        background.add(cuatroEstrellas, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 490, 230, 50));
        cuatroEstrellas.setIcon(new ImageIcon("Imagenes/4Estrella.png"));
        background.add(cincoEstrellas, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 490, 250, 50));
    ...
    private void calificarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calificarBotonActionPerformed
         ...
         if(!restaurantesLista.isSelectionEmpty())
         {
             if(unaEstrellaRBoton.isSelected())
             {
                ...
                //Actualizo la pagina
                CalificarRestauranteCliente reinicio = new CalificarRestauranteCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalificarRestauranteCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalificarRestauranteCliente().setVisible(true);
            }
        });
    }
